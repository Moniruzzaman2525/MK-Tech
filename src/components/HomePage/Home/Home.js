    ...
    return (
        <div class="hero my-20">
            <div class="hero-content flex-col lg:flex-row-reverse">
                <img src="https://img.freepik.com/free-photo/independence-day-composition-with-festive-elements_23-2148959469.jpg?w=1060&t=st=1654497340~exp=1654497940~hmac=314fe244c8222615597f0cc1b1e52c2cf1db15aeaa4da041e34e9a80dc967637" class="max-w-lg rounded-lg shadow-2xl" />
                <div>
